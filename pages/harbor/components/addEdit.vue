  ...
  >
    <el-form :model="form" :rules="rules" ref="formRef" size="mini" label-width="120px">
      <el-row :gutter="20">
       <!-- 港口代码 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_code')" prop="code">
        <el-input v-model="form.code" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 港口名称 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_portCnName')" prop="portCnName">
        <el-input v-model="form.portCnName" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 港口英文名 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_portEnName')" prop="portEnName">
        <el-input v-model="form.portEnName" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 港口类型 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_type')" prop="type">
        <el-input v-model="form.type" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 所属大区 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_area')" prop="area">
        <el-input v-model="form.area" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 国家/地区 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_country')" prop="country">
        <el-input v-model="form.country" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 省/州 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_province')" prop="province">
        <el-input v-model="form.province" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 城市 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_city')" prop="city">
        <el-input v-model="form.city" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 口岸 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_portCode')" prop="portCode">
        <el-input v-model="form.portCode" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 时区 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_timezone')" prop="timezone">
        <el-input v-model="form.timezone" disabled  ></el-input>
      </el-form-item>
      </el-col>
      <!-- 班期 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_workCycle')" prop="workCycle">
    ...
    <el-option :value="2" label="禁用"></el-option>
      ...
      <!-- 最大处理能力（箱/包裹） -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_maxProcessingPower')" prop="maxProcessingPower">
        <el-input v-model="form.maxProcessingPower"   ></el-input>
      </el-form-item>
      </el-col>
      <!-- 状态 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_status')" prop="status">
    ...
    <el-option :value="2" label="禁用"></el-option>
      ...
      <!-- 备注 -->
    <el-col :span="24">
    <el-form-item :label="$t('harbor_remark')" prop="remark">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const rules = {
      ...
      portCnName : [{ required: true, message: proxy.$t('please_enter'), trigger: 'blur' }],
      portEnName : [{ required: true, message: proxy.$t('please_enter'), trigger: 'blur' }],
      ...
      portCode : [{ required: true, message: proxy.$t('please_enter'), trigger: 'blur' }],
